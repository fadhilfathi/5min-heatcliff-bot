...
BTC_MOVE_THRESHOLD = 33.0
STAKE_USD_PER_ENTRY = 0.50
ENTRY_SHARES = 1
TAKE_PROFIT_PCT = 0.01
FORCE_EXIT_SECONDS = 15
FORCE_EXIT_MIN_PROFIT_PCT = 0.00
INITIAL_ENTRY_MAX_SECS_LEFT = 150
INITIAL_ENTRY_MIN_SECS_LEFT = 15
INITIAL_ENTRY_MAX_ASK = 0.99
FLIP_MOVE_THRESHOLD = 70.0
HEDGE_OPPOSITE_ASK_THRESHOLD = 0.88
HEDGE_OPPOSITE_MOVE_THRESHOLD = 25
HEDGE2_MOVE_THRESHOLD = 20
HEDGE2_ASK_THRESHOLD = 0.85
